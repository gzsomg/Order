<template>
    <div class="u-childdepartmentregistration">
                    ...
                    <el-row>
                        ...
                        <el-col :span="19">
                            <div class="hospital-detail">
                                ...
                                <h3>{{scope.row.d_name}}&nbsp;|&nbsp;<span class="child">{{scope.row.s_name}}</span></h3>
                                <p>
...
export default {
  ...
  methods: {
    _getDetail() {
      if (this.childdepartment.length > 0) {
        this.key = this.childdepartment;
        axios
          .get(
            this.$api.getchilddepartmentlistbyname +
        ...
        this.$router.push('/user/departmentregistration');
        return;
      }
    },
